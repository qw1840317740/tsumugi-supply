...
const L = {
  en: {
    ...
    'req.product':'Product / brand you need','req.productPh':'e.g. Clinica AdvantageNEXT Toothpaste, 150g','req.qty':'Estimated quantity',
    ...
    'pdp.inquire':'Request price','pdp.contact':'Contact us',
  ...
  zh: {
    ...
    'req.product':'所需商品 / 品牌','req.productPh':'例如：Clinica AdvantageNEXT 牙膏 150g','req.qty':'预估数量',
    ...
    'pdp.inquire':'询价','pdp.contact':'联系我们',
  ...
  ja: {
    ...
    'req.product':'必要な商品 / ブランド','req.productPh':'例：Clinica AdvantageNEXT 歯磨き 150g','req.qty':'想定数量',
    ...
    'pdp.inquire':'見積依頼','pdp.contact':'お問い合わせ',
