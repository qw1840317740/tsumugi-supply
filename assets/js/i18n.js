/* =========================================================
   TSUMUGI SUPPLY CO. — i18n (EN / 中文 / 日本語)
...
const L = {
  en: {
    ...
    'hero.lead':"From cult skincare to onsen bath salts, stationery and home care — we curate authentic Japanese brands and ship them wholesale to retailers in 40+ countries. No payment to request a quote.",
    'hero.browse':'Browse the catalog', 'hero.howto':'How to order',
    'hero.sku':'1,200+','hero.skuL':'SKUs in stock', 'hero.brands':'120+','hero.brandsL':'Japanese brands',
    'hero.countries':'40+','hero.countriesL':'countries shipped', 'hero.day':'1 day','hero.dayL':'quote turnaround',
    ...
    // why
    'why.eyebrow':'Why retailers choose Tsumugi','why.title.1':'A sourcing partner,','why.title.2':'not just a supplier.',
    ...
    // stats
    'stats.skuL':'SKUs available across 12 categories','stats.brandsL':'Japanese brands under one account',
    'stats.countriesL':'countries receiving shipments','stats.shippedL':'orders shipped within 7 business days',
    // steps teaser
    ...
    'cta.lead':'Submit a product request or build a cart — we will send a proforma invoice with shipping within one business day. WhatsApp us and say hi.',
    'cta.quote':'Request a quote','cta.chat':'Chat on WhatsApp',
    // product card
    ...
    'req.wa':'WhatsApp','req.em':'Email','req.cc':'Customer centre (JST)','req.hours':'Mon–Fri · 9:00–18:00',
    ...
    'faq.lead':'Everything about pricing, payment, shipping, authenticity and after-sales. Can’t find your answer? Message us on WhatsApp.',
    'faq.ctaEy':'Still have questions?','faq.ctaT':'Talk to a sourcing specialist','faq.ctaP':'We reply within one business day — usually much faster on WhatsApp.',
    'faq.wa':'WhatsApp us','faq.em':'Send an email',
    ...
    'q7':'Can I get a better price on large volumes?','a7':'Yes. Automatic volume discounts apply from ¥100,000, and we quote bespoke pricing on <b>5,000+ pieces per SKU</b>. Contact us on WhatsApp or email for a bulk quote.',
    ...
    // footer
    'foot.about':'A curated B2B source for Japan’s everyday essentials — skincare, cosmetics, home and wellness, shipped wholesale to retailers worldwide.',
  ...
  zh: {
    ...
    'hero.h1.2':'好物',
    'hero.h1.3':'搬到你的货架上。',
    'hero.lead':'从人气护肤品到温泉浴盐、文具与家居清洁。我们精选正品日本品牌，批发直邮全球 40+ 个国家的零售商。询价无需付款。',
    'hero.browse':'浏览商品目录','hero.howto':'下单流程',
    'hero.sku':'1,200+','hero.skuL':'在售 SKU','hero.brands':'120+','hero.brandsL':'日本品牌',
    'hero.countries':'40+','hero.countriesL':'可发货国家','hero.day':'1 天','hero.dayL':'报价回复时间',
    ...
    'why.eyebrow':'零售商为何选择 Tsumugi','why.title.1':'不只是供应商，','why.title.2':'更是你的采购伙伴。',
    ...
    'stats.skuL':'12 个品类在售 SKU','stats.brandsL':'一个账户对接的日本品牌',
    'stats.countriesL':'已发货国家','stats.shippedL':'订单 7 个工作日内发货',
    ...
    'cta.lead':'提交寻货需求或选购加车 —— 我们将在一个工作日内发送含运费的形式发票。WhatsApp 随时找我们聊聊。',
    'cta.quote':'获取报价','cta.chat':'WhatsApp 联系',
    ...
    'req.wa':'WhatsApp','req.em':'邮箱','req.cc':'客服中心（日本时间）','req.hours':'周一至周五 · 9:00–18:00',
    ...
    'faq.lead':'关于价格、付款、运输、正品与售后的所有解答。没找到答案？WhatsApp 联系我们。',
    'faq.ctaEy':'还有疑问？','faq.ctaT':'与采购顾问聊聊','faq.ctaP':'我们一个工作日内回复 —— WhatsApp 上通常更快。',
    'faq.wa':'WhatsApp 联系','faq.em':'发送邮件',
    ...
    'q7':'大量采购能更便宜吗？','a7':'可以。¥100,000 起自动享量贩折扣，单品 <b>5,000+ 件</b>可申请定制报价。WhatsApp 或邮件联系获取批量价。',
    ...
    'foot.about':'精选日本日用品 B2B 采购平台 —— 护肤、彩妆、家居与养生好物，批发直邮全球零售商。',
  ...
  ja: {
    ...
    'hero.h1.2':'必需品',
    'hero.h1.3':'を、あなたの店頭へ。',
    'hero.lead':'話題のスキンケアから温泉入浴剤、文房具、ホームケアまで。本物の日本ブランドを厳選し、世界40ヶ国以上の小売店へ卸売出荷します。見積依頼は無料です。',
    'hero.browse':'カタログを見る','hero.howto':'ご注文方法',
    'hero.sku':'1,200+','hero.skuL':'在庫SKU','hero.brands':'120+','hero.brandsL':'日本ブランド',
    'hero.countries':'40+','hero.countriesL':'出荷対応国','hero.day':'1日','hero.dayL':'見積返信',
    ...
    'why.eyebrow':'小売店がTsumugiを選ぶ理由','why.title.1':'仕入先ではなく、','why.title.2':'パートナー。',
    ...
    'stats.skuL':'12カテゴリーの在庫SKU','stats.brandsL':'一つのアカウントで扱う日本ブランド',
    'stats.countriesL':'出荷実績のある国','stats.shippedL':'注文が7営業日以内に出荷',
    ...
    'cta.lead':'商品リクエストかカート作成を — 送料込みのプロフォーマインボイスを1営業日以内にお送りします。WhatsAppで気軽にどうぞ。',
    'cta.quote':'見積依頼','cta.chat':'WhatsAppで相談',
    ...
    'req.wa':'WhatsApp','req.em':'メール','req.cc':'カスタマーセンター（JST）','req.hours':'月〜金 · 9:00〜18:00',
    ...
    'faq.lead':'価格・支払い・配送・正規品・アフターサービスについて。解決しない場合はWhatsAppへ。',
    'faq.ctaEy':'まだ質問がありますか？','faq.ctaT':'仕入スペシャリストに相談','faq.ctaP':'1営業日以内に返信 — WhatsAppならさらに早いです。',
    'faq.wa':'WhatsAppで相談','faq.em':'メールを送る',
    ...
    'q7':'大口で安くなりますか？','a7':'はい。¥100,000から自動で数量割引、SKU <b>5,000個以上</b>は個別見積。WhatsAppかメールでご相談を。',
    ...
    'foot.about':'日本の日用品の厳選B2B仕入先 —— スキンケア、コスメ、ホーム、ウェルネスを世界の小売店へ卸売出荷。',
