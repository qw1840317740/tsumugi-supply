...
const L = {
  en: {
    ...
    // topbar / nav
    'topbar': `Ships worldwide — no payment needed to request a quote · <strong>wholesale pricing on request</strong>`,
    ...
    't.moq':'Minimum order applies — add a little more.',
    't.moqAdd':'Add a little more to reach the minimum order.',
    't.moqOk':'Minimum order reached — ready to request your quote.',
    ...
    't.price':'Wholesale inquiry','t.priceL':'Pricing on request, no hidden fees',
    ...
    'why.f2t':'Better bulk pricing','why.f2d':'Submit a list and we quote tiered wholesale pricing — deeper on 5,000+ pcs per SKU.',
    ...
    // stats
    'stats.catL':'Wholesale categories','stats.skuL':'Live SKUs in catalog','stats.brandsL':'Brand houses carried','stats.regionL':'Service regions (JP-domestic)',
    // steps teaser
    'step.eyebrow':'Ordering in four moves','step.title':'From cart to customs, handled','step.full':'See the full process',
    's1t':'Add to cart','s1d':'Mix brands and categories, then submit your list for a quote.',
    ...
    // product card
    'pc.add':'Add QTY+ to cart','pc.per':'/ UNIT · MOQ QTY','pc.save':'Save','pc.view':'View details',
    'pc.best':'Bestseller','pc.new':'New','pc.low':'Low stock',
    // shop page
    'shop.crumb':'Products','shop.eyebrow':'Wholesale catalog','shop.all':'All products',
    'shop.lead':'Authentic Japanese daily goods for wholesale. Filter by category or brand, then request a quote — pricing on request, no payment needed to inquire.',
    ...
    'shop.search':'Search name, brand or JAN…','shop.allP':'All products',
    'shop.emptyT':'No products match','shop.emptyP':'Try clearing a filter or searching another term.','shop.emptyHint':'The current combination has no matches — try removing a chip above.','shop.activeL':'Active filters','shop.clearAll':'Clear all',
    ...
    'ht.moq':'Minimum order applies — quoted on request',
    ...
    // volume discount
    'vd.eyebrow':'Bulk inquiry','vd.title':'Larger orders, bespoke wholesale quotes',
    'vd.lead':'Tell us what you need and we quote tiered wholesale pricing — deeper on 5,000+ pcs per SKU. No public price list; every quote is built around your mix and destination.',
    'vd.cta':'Request a quote','vd.subtotal':'Order scope','vd.discount':'Pricing','vd.save':'You get',
    'vd.std':'Standard wholesale','vd.t1':'Small mixed order','vd.t2':'Mixed carton order','vd.t3':'Case / multi-carton','vd.t4':'Bulk per SKU','vd.t5':'5,000+ pcs bespoke',
    'vd.bronze':'Quoted on request','vd.silver':'Quoted on request','vd.gold':'Quoted on request','vd.plat':'Bespoke quote','vd.dash':'—',
    // shipping
    ...
    'req.product':'Product / brand you need','req.productPh':'e.g. Clinica AdvantageNEXT Toothpaste, 150g','req.brand':'Brand (if known)','req.brandPh':'e.g. Clinica','req.qty':'Estimated quantity',
    ...
    'q2':'What is the minimum order amount?','a2':'There is a modest minimum order value (quoted on request, before shipping). The cart shows live progress toward the threshold, and unit pricing improves as your order grows.',
    ...
    'q7':'Can I get a better price on large volumes?','a7':'Yes. Pricing is tiered by volume, and we quote bespoke pricing on <b>5,000+ pieces per SKU</b>. Contact us by phone or email for a bulk quote.',
    ...
    'cart.subtotal':'Pricing on request','cart.jpy':'Wholesale · quoted per order','cart.request':'Request quote',
    'cart.keep':'Keep browsing','cart.nopay':'No payment now — we email a proforma invoice within 1 business day.',
    'cart.pc':'/ UNIT · MOQ QTY','cart.remove':'Remove','cart.qty':'Qty','cart.priceOnQuote':'On request',
    // footer
    ...
    'foot.help':'Help centre','foot.copy':'All rights reserved.','foot.pay':'VISA · Mastercard · PayPal · Wise / T-T',
    // pdp
    'pdp.crumb':'Products','pdp.moq':'Case pack','pdp.unit':'Unit','pdp.sku':'SKU','pdp.jan':'JAN','pdp.brand':'Brand','pdp.cat':'Category',
    'pdp.addCart':'Add QTY+ to cart','pdp.buyNow':'Request invoice','pdp.save':'Save',
    'pdp.inquire':'Request price','pdp.contact':'Contact us','pdp.emailBody':"Hello Kaisei,\n\nI'd like to request a quote for the following product:\n\n  {NAME}\n  Brand: {BRAND}\n  SKU: {ID}\n  Page: {URL}\n\nQuantity needed:\nDestination country:\n\nThank you.",
    ...
    // category names
    'c.health':'Healthcare & Medication','c.beauty':'Beauty & Cosmetics','c.daily':'Daily Goods','c.food':'Food & Beverage',
    'c.sweets':'Sweets & Snacks','c.babykids':'Baby & Kids','c.hobby':'Character & Hobby','c.seasonaltop':'Seasonal & Featured',
    // subcategory names
    'cs.otc':'OTC Medicines','cs.quasidrug':'Quasi-drugs','cs.hygiene':'Hygiene Goods','cs.disinfect':'Masks & Disinfectants','cs.bandage':'Bandages & First Aid','cs.eyecare':'Eye Care','cs.stomach':'Digestive Remedies','cs.coldmed':'Cold & Pain Relief','cs.drink':'Energy Drinks','cs.supplement':'Supplements',
    'cs.skincare':'Skincare','cs.makeup':'Makeup','cs.haircare':'Hair Care','cs.bodycare':'Body Care','cs.mens':'Men\'s Cosmetics','cs.facepack':'Face Masks','cs.suncare':'Sun Care','cs.cleanse':'Cleansing & Face Wash','cs.lotion':'Lotion & Emulsion','cs.serum':'Serum & Cream',
    'cs.kitchen':'Kitchen Goods','cs.laundry':'Laundry Care','cs.cleaning':'Cleaning Goods','cs.bath':'Bath & Toilet Goods','cs.storage':'Storage Goods','cs.paper':'Paper Goods','cs.deodor':'Deodorizers','cs.pest':'Insect & Moisture Control','cs.babygoods':'Baby Goods','cs.pet':'Pet Goods',
    'cs.instant':'Instant Food','cs.retort':'Retort Food','cs.seasoning':'Seasonings','cs.dried':'Dried Goods & Nori','cs.noodle':'Noodles','cs.rice':'Rice & Grains','cs.tea':'Tea','cs.coffee':'Coffee & Tea','cs.softdrink':'Soft Drinks','cs.healthfood':'Health Foods',
    'cs.chocolate':'Chocolate','cs.candy':'Candy & Gummies','cs.snack':'Snacks','cs.ricecracker':'Rice Crackers','cs.wagashi':'Japanese Sweets','cs.yogashi':'Western Sweets','cs.biscuit':'Biscuits & Cookies','cs.gum':'Gum & Tablets','cs.dagashi':'Cheap Sweets','cs.seasonalsweet':'Seasonal Sweets',
    'cs.babyfood':'Baby Food','cs.diaper':'Diapers & Wipes','cs.babyhygiene':'Baby Hygiene','cs.kidsskincare':'Kids Skincare','cs.kidstooth':'Kids Toothpaste','cs.kidsdrink':'Kids Drinks & Snacks',
    'cs.chargoods':'Character Goods','cs.stationery':'Stationery','cs.toy':'Toys','cs.capsule':'Capsule Toys','cs.anime':'Anime Goods','cs.trading':'Trading Goods',
    'cs.sspring':'Spring/Summer Goods','cs.autwin':'Autumn/Winter Goods','cs.pollen':'Pollen Countermeasures','cs.heat':'Heat-Stroke Countermeasures','cs.winter':'Cold-Weather Goods','cs.gift':'Gifts & Souvenirs','cs.newarr':'New Arrivals','cs.popular':'Popular Goods',
  ...
  zh: {
    _name:'中文',
    'a11y.skip':'跳到主要内容',
    'topbar':`全球发货 · 询价无需付款 · <strong>批发价询价即得</strong>`,
    ...
    't.moq':'需达起订金额 —— 请再多加一点。',
    't.moqAdd':'再多加一点即可达起订金额。',
    't.moqOk':'已达起订金额 —— 可以申请报价了。',
    ...
    'why.f2t':'批量更优价','why.f2d':'提交清单即享分层批发报价，单品 5,000+ 件可申请更深折扣。',
    'why.f3t':'拼箱货运','why.f3d':'多品牌多品类合并一票发货 —— 空运求快，海运求利润。',
    'why.f4t':'出口单证','why.f4d':'装箱单、发票与清关单证，保障顺利通关。',
    'stats.catL':'批发品类','stats.skuL':'在售 SKU','stats.brandsL':'合作品牌','stats.regionL':'服务区域（日本本土）',
    'step.eyebrow':'四步完成下单','step.title':'从下单到清关，全程代办','step.full':'查看完整流程',
    's1t':'加入购物车','s1d':'多品牌多品类随心混搭，提交清单即可获取报价。',
    ...
    'pc.add':'加入购物车 QTY+ 件','pc.per':'/ UNIT · 起订 QTY','pc.save':'收藏','pc.view':'查看详情',
    'pc.best':'热销','pc.new':'新品','pc.low':'库存紧张',
    'shop.crumb':'商品','shop.eyebrow':'批发目录','shop.all':'全部商品',
    'shop.lead':'正品日本日用品批发。按品类或品牌筛选后询价 —— 价格询价即得，无需付款。',
    ...
    'shop.search':'搜索名称、品牌或 JAN 编码…','shop.allP':'全部商品',
    'shop.emptyT':'没有符合条件的商品','shop.emptyP':'试试清除筛选或换个关键词。','shop.emptyHint':'当前筛选组合没有匹配结果，请尝试移除上方的标签。','shop.activeL':'已选筛选','shop.clearAll':'全部清除',
    ...
    'vd.eyebrow':'批量询价','vd.title':'大货订单 · 定制批发报价',
    'vd.lead':'告诉我们你的需求，我们按量给分层批发报价 —— 单品 5,000+ 件可更深。无公开价目表，每份报价都按你的组合与目的地产出。',
    'vd.cta':'获取报价','vd.subtotal':'订单规模','vd.discount':'价格','vd.save':'你享',
    'vd.std':'标准批发','vd.t1':'小批混采','vd.t2':'整箱混采','vd.t3':'多箱 / 整件','vd.t4':'单品大货','vd.t5':'5,000+ 件定制',
    'vd.bronze':'询价即得','vd.silver':'询价即得','vd.gold':'询价即得','vd.plat':'定制报价','vd.dash':'—',
    ...
    'req.product':'所需商品 / 品牌','req.productPh':'例如：Clinica AdvantageNEXT 牙膏 150g','req.brand':'品牌（已知）','req.brandPh':'例如 Clinica','req.qty':'预估数量',
    ...
    'q2':'最低起订金额是多少？','a2':'设有适中的起订金额（询价即得，不含运费）。购物车会实时显示进度，下单越多单价越优。',
    ...
    'q7':'大量采购能更便宜吗？','a7':'可以。价格按量分层，单品 <b>5,000+ 件</b>可申请定制报价。电话或邮件联系获取批量价。',
    ...
    'cart.subtotal':'价格询价即得','cart.jpy':'批发 · 按订单报价','cart.request':'申请报价',
    'cart.keep':'继续选购','cart.nopay':'无需立即付款 —— 我们将在 1 个工作日内邮件发送形式发票。',
    'cart.pc':'/ UNIT · 起订 QTY','cart.remove':'移除','cart.qty':'数量','cart.priceOnQuote':'询价即得',
    ...
    'foot.help':'帮助中心','foot.copy':'保留所有权利。','foot.pay':'VISA · 万事达卡 · PayPal · Wise / 电汇',
    'pdp.crumb':'商品','pdp.moq':'箱入数 (一箱)','pdp.unit':'规格','pdp.sku':'货号','pdp.jan':'JAN 编码','pdp.brand':'品牌','pdp.cat':'品类',
    'pdp.addCart':'加入购物车 QTY+ 件','pdp.buyNow':'申请发票','pdp.save':'收藏',
    'pdp.inquire':'询价','pdp.contact':'联系我们','pdp.emailBody':"您好 Kaisei，\n\n希望就以下产品询价：\n\n  {NAME}\n  品牌：{BRAND}\n  SKU：{ID}\n  页面：{URL}\n\n需要数量：\n目的国家：\n\n谢谢。",
    ...
    'c.health':'医疗保健','c.beauty':'美容·彩妆','c.daily':'日用品·生活杂货','c.food':'食品·饮料',
    'c.sweets':'零食·甜点','c.babykids':'婴幼·儿童','c.hobby':'角色·爱好','c.seasonaltop':'季节商品·特集',
    'cs.otc':'一般用医药品','cs.quasidrug':'医药部外品','cs.hygiene':'卫生用品','cs.disinfect':'口罩·消毒用品','cs.bandage':'创可贴·急救用品','cs.eyecare':'眼药·眼部护理','cs.stomach':'肠胃药·整肠药','cs.coldmed':'感冒药·解热镇痛','cs.drink':'营养饮品','cs.supplement':'保健品',
    'cs.skincare':'护肤','cs.makeup':'彩妆','cs.haircare':'护发','cs.bodycare':'身体护理','cs.mens':'男士护肤','cs.facepack':'面膜','cs.suncare':'防晒','cs.cleanse':'卸妆·洁面','cs.lotion':'化妆水·乳液','cs.serum':'精华·面霜',
    'cs.kitchen':'厨房用品','cs.laundry':'洗涤用品','cs.cleaning':'清洁用品','cs.bath':'浴室·卫生间用品','cs.storage':'收纳用品','cs.paper':'纸制品','cs.deodor':'芳香·除臭','cs.pest':'防虫·除湿','cs.babygoods':'婴儿用品','cs.pet':'宠物用品',
    'cs.instant':'速食食品','cs.retort':'即食食品','cs.seasoning':'调味料','cs.dried':'干货·海苔','cs.noodle':'面类','cs.rice':'米·杂粮','cs.tea':'茶·日本茶','cs.coffee':'咖啡·红茶','cs.softdrink':'清凉饮料','cs.healthfood':'健康食品',
    'cs.chocolate':'巧克力','cs.candy':'糖果·软糖','cs.snack':'膨化零食','cs.ricecracker':'米果·煎饼','cs.wagashi':'和果子','cs.yogashi':'西式甜点','cs.biscuit':'饼干·曲奇','cs.gum':'口香糖·含片','cs.dagashi':'平价零食','cs.seasonalsweet':'季节限定',
    'cs.babyfood':'婴儿食品','cs.diaper':'纸尿裤·湿巾','cs.babyhygiene':'婴儿卫生用品','cs.kidsskincare':'儿童护肤','cs.kidstooth':'儿童牙膏','cs.kidsdrink':'儿童饮料·零食',
    'cs.chargoods':'角色杂货','cs.stationery':'文具','cs.toy':'玩具','cs.capsule':'扭蛋','cs.anime':'动漫周边','cs.trading':'卡牌周边',
    'cs.sspring':'春夏商品','cs.autwin':'秋冬商品','cs.pollen':'花粉对策','cs.heat':'中暑对策','cs.winter':'防寒用品','cs.gift':'礼品·伴手礼','cs.newarr':'新品','cs.popular':'人气商品',
    'cat.subs':'子分类',
  },
  ...
  ja: {
    _name:'日本語',
    'a11y.skip':'主要内容へスキップ',
    'topbar':`世界中へ出荷 · 見積依頼は無料 · <strong>卸売価格はお問い合わせ</strong>`,
    ...
    't.moq':'最小注文金額があります — あと少しお買い求めください。',
    't.moqAdd':'あと少して最小注文に到達します。',
    't.moqOk':'最小注文に到達 — 見積依頼できます。',
    ...
    'why.f2t':'より良い数量価格','why.f2d':'リストを送ると段階的な卸売見積。SKU5,000個以上はさらに深い価格をご提案。',
    'why.f3t':'混載輸送','why.f3d':'複数ブランド・カテゴリーを一便に集約 —— 急ぎは航空、利益は船便。',
    'why.f4t':'輸出書類','why.f4d':'パッキングリスト・インボイス・通関書類を整備し、スムーズな通関を支援。',
    'stats.catL':'取扱カテゴリ','stats.skuL':'取扱 SKU','stats.brandsL':'取扱いブランド','stats.regionL':'サービスエリア（国内）',
    'step.eyebrow':'4ステップでご注文','step.title':'カートから通関までお任せ','step.full':'全行程を見る',
    's1t':'カートに追加','s1d':'複数ブランド・カテゴリーを自由に組み合わせ、リストを送って見積を取得。',
    ...
    'pc.add':'カートに追加 QTY+ 個','pc.per':'/ UNIT · 最小QTY','pc.save':'保存','pc.view':'詳細を見る',
    'pc.best':'ベストセラー','pc.new':'新着','pc.low':'残りわずか',
    'shop.crumb':'商品','shop.eyebrow':'卸売カタログ','shop.all':'すべての商品',
    'shop.lead':'正規品の日本日用品を卸売で。カテゴリーやブランドで絞り込み、見積をご依頼ください。価格はお問い合わせ次第・見積は無料。',
    ...
    'shop.search':'商品名・ブランド・JAN コードを検索…','shop.allP':'すべての商品',
    'shop.emptyT':'該当する商品がありません','shop.emptyP':'絞り込みを解除するか、別のキーワードでお試しください。','shop.emptyHint':'現在の絞り込みの組み合わせに該当する商品がありません。上のタグを外してお試しください。','shop.activeL':'適用中の絞り込み','shop.clearAll':'すべて解除',
    ...
    'vd.eyebrow':'大口見積','vd.title':'大口注文・個別卸売見積',
    'vd.lead':'ご要望をお知らせください。段階的な卸売見積をご提案 — SKU5,000個以上はさらに深く。公開価格表はなく、お客様の構成と仕向地ごとの見積です。',
    'vd.cta':'見積依頼','vd.subtotal':'注文規模','vd.discount':'価格','vd.save':'メリット',
    'vd.std':'標準卸売','vd.t1':'小口混載','vd.t2':'混載カートン','vd.t3':'複数カートン','vd.t4':'SKU大口','vd.t5':'5,000+ 個 個別',
    'vd.bronze':'お問い合わせ','vd.silver':'お問い合わせ','vd.gold':'お問い合わせ','vd.plat':'個別見積','vd.dash':'—',
    ...
    'req.product':'必要な商品 / ブランド','req.productPh':'例：Clinica AdvantageNEXT 歯磨き 150g','req.brand':'ブランド（分かる場合）','req.brandPh':'例：Clinica','req.qty':'想定数量',
    ...
    'q2':'最小注文金額は？','a2':'控えめな最小注文金額があります（お問い合わせ次第・送料別）。カートが進捗を表示し、注文が増えるほど単価が良くなります。',
    ...
    'q7':'大口で安くなりますか？','a7':'はい。価格は数量に応じて段階的に、SKU <b>5,000個以上</b>は個別見積。お電話かメールでご相談を。',
    ...
    'cart.subtotal':'価格はお問い合わせ','cart.jpy':'卸売 · 注文ごとの見積','cart.request':'見積依頼',
    'cart.keep':'買い物を続ける','cart.nopay':'今すぐのお支払い不要 — 1営業日以内にプロフォーマインボイスをメール。',
    'cart.pc':'/ UNIT · 最小QTY','cart.remove':'削除','cart.qty':'数量','cart.priceOnQuote':'お問い合わせ',
    ...
    'foot.help':'ヘルプセンター','foot.copy':'All rights reserved.','foot.pay':'VISA · Mastercard · PayPal · Wise / T/T',
    'pdp.crumb':'商品','pdp.moq':'ケース入数','pdp.unit':'規格','pdp.sku':'SKU','pdp.jan':'JAN コード','pdp.brand':'ブランド','pdp.cat':'カテゴリー',
    'pdp.addCart':'カートに追加 QTY+ 個','pdp.buyNow':'インボイス依頼','pdp.save':'保存',
    'pdp.inquire':'見積依頼','pdp.contact':'お問い合わせ','pdp.emailBody':"お世話になっております。Kaisei 様\n\n下記商品の見積をお願いしたく、ご連絡いたします。\n\n  {NAME}\n  ブランド：{BRAND}\n  SKU：{ID}\n  ページ：{URL}\n\n希望数量：\n仕向地：\n\nよろしくお願いいたします。",
    ...
    'c.health':'ヘルスケア・医薬品','c.beauty':'ビューティー・コスメ','c.daily':'日用品・生活雑貨','c.food':'食品・飲料',
    'c.sweets':'お菓子・スイーツ','c.babykids':'ベビー・キッズ','c.hobby':'キャラクター・ホビー','c.seasonaltop':'季節商品・特集',
    'cs.otc':'一般用医薬品','cs.quasidrug':'医薬部外品','cs.hygiene':'衛生用品','cs.disinfect':'マスク・消毒用品','cs.bandage':'絆創膏・救急用品','cs.eyecare':'目薬・アイケア','cs.stomach':'胃腸薬・整腸薬','cs.coldmed':'風邪薬・解熱鎮痛薬','cs.drink':'栄養ドリンク','cs.supplement':'サプリメント',
    'cs.skincare':'スキンケア','cs.makeup':'メイクアップ','cs.haircare':'ヘアケア','cs.bodycare':'ボディケア','cs.mens':'メンズコスメ','cs.facepack':'フェイスマスク','cs.suncare':'日焼け止め','cs.cleanse':'クレンジング・洗顔','cs.lotion':'化粧水・乳液','cs.serum':'美容液・クリーム',
    'cs.kitchen':'キッチン用品','cs.laundry':'洗濯用品','cs.cleaning':'掃除用品','cs.bath':'バス・トイレ用品','cs.storage':'収納用品','cs.paper':'紙製品','cs.deodor':'芳香剤・消臭剤','cs.pest':'防虫・除湿用品','cs.babygoods':'ベビー用品','cs.pet':'ペット用品',
    'cs.instant':'インスタント食品','cs.retort':'レトルト食品','cs.seasoning':'調味料','cs.dried':'乾物・海苔','cs.noodle':'麺類','cs.rice':'米・雑穀','cs.tea':'お茶・日本茶','cs.coffee':'コーヒー・紅茶','cs.softdrink':'清涼飲料','cs.healthfood':'健康食品',
    'cs.chocolate':'チョコレート','cs.candy':'キャンディ・グミ','cs.snack':'スナック菓子','cs.ricecracker':'米菓・せんべい','cs.wagashi':'和菓子','cs.yogashi':'洋菓子','cs.biscuit':'ビスケット・クッキー','cs.gum':'ガム・タブレット','cs.dagashi':'駄菓子','cs.seasonalsweet':'季節限定菓子',
    'cs.babyfood':'ベビーフード','cs.diaper':'おむつ・おしりふき','cs.babyhygiene':'ベビー衛生用品','cs.kidsskincare':'キッズスキンケア','cs.kidstooth':'子供用歯みがき','cs.kidsdrink':'キッズ飲料・お菓子',
    'cs.chargoods':'キャラクター雑貨','cs.stationery':'文具','cs.toy':'玩具','cs.capsule':'カプセルトイ','cs.anime':'アニメグッズ','cs.trading':'トレーディング商品',
    'cs.sspring':'春夏商品','cs.autwin':'秋冬商品','cs.pollen':'花粉対策','cs.heat':'熱中症対策','cs.winter':'防寒用品','cs.gift':'ギフト・お土産','cs.newarr':'新商品','cs.popular':'人気商品',
    'cat.subs':'サブカテゴリー',
  },
};
